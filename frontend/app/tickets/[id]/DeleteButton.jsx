...
export default function DeleteButton({ ticketId }) {
  ...
  return (
    <button
      ...
      disabled={isDeleting}
      className="bg-rose-600 hover:bg-rose-700 text-white font-bold px-3 py-1.5 rounded text-[13px] transition-none disabled:opacity-50 flex justify-center items-center gap-2"
    >
