          ...
          <form onSubmit={handleLogin} className="space-y-6 bg-transparent border-0 shadow-none p-0 max-w-full my-0">
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg text-sm text-slate-850 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all min-h-[44px]"
                value={email}
